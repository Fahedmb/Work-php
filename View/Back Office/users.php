...
require_once '../../Controller/userC/utilisateursC.php';
                  ...
                  <tbody>
                    <?php foreach ($filteredUsers as $user): ?>
                      <tr>
                        ...
                        <td><?php echo $user['numeroTelephone']; ?></td>
                        <td><?php echo $user['adresse']; ?></td>
                        <td>
                          <a href="../../Controller/userC/delete_user.php?id=<?php echo $user['id']; ?>"
                            class="btn btn-danger">Delete</a>
                          <?php if ($user['role'] === 'Utilisateur'): ?>
                            <a href="../../Controller/userC/make_admin.php?id=<?php echo $user['id']; ?>"
                              class="btn btn-success">Make Admin</a>
                          <?php elseif ($user['role'] === 'Administrateur'): ?>
                            <a href="../../Controller/userC/make_user.php?id=<?php echo $user['id']; ?>"
                              class="btn btn-warning">Make User</a>
                          <?php endif; ?>
                        </td>
                      </tr>
                    <?php endforeach; ?>
